...
<body>
	<nav
		...
		<div class="container-fluid px-md-4	">
			<a class="navbar-brand" href="../index.do">Every Football</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item cta mr-md-1"><a href="./login.jsp"
						class="nav-link">Login</a></li>
					<li class="nav-item cta cta-colored"><a href="mypage.do"
						class="nav-link">MyPage</a></li>
					<li class="nav-item cta mr-md-1"><a href="/logout.html"
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-md-12 col-lg-8 mb-5">
					...
					<form action="login.do" method="post" class="p-5 bg-white">
						...
						<a href="signup.jsp" class="mr-2">회원가입</a> <a href="findidpw.jsp"
							class="">아이디/비밀번호 찾기</a>
